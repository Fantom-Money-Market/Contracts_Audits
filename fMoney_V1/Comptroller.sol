...
/*Initial comptroller for sonic deployment, to be updated before going live*/

/**
 * @title Compound's Comptroller Contract
 * @author Compound
 * @notice fMoney Comptroller V1
 */
    ...
    ExponentialNoError
{
    ...
    function getMsigAddress() public view virtual returns (address) {
        return 0x65Be240291384570997cb62516eB27C543f82eE1;
    }

    /** 
     * @notice fMoney addition: Allows managing emissions between main market and future eco/iso markets separate from main lender.
