...
This oracle reads the same feeds as non emergency Oracle (main lender oracle)
But with at risk asset's feed(s) ponting to it's PythAggregatorV3Emergency contract.
Only for use in case of an on-chain depeg event.
...
contract EmergencyPriceOracle is PriceOracle {
