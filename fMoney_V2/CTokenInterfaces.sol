...
contract CTokenStorage {
    ...
    /**
     * @notice Percentage of total supplied underlying that must remain at rest in market. Optional buffer.
     */
    uint public utilBuffer; // in basis points (1000 = 10%)
}
...
abstract contract CTokenInterface is CTokenStorage {
    ...
    /**
     * @notice Event emitted when utilization buffer is changed
     */
    event UtilBufferSet(uint oldUBuffer, uint newBuffer);
    ...
    function _setUtilBuffer(uint newBuffer) virtual external returns (uint);
}
